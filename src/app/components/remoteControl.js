        ...
        return (
            <div className="remote-controller" style={style}>
                ...
                <div className="casing">
                    ...
                    <div className="button-row">
                        <CombinedButton type="vol" buttonType="square" color="blue" buttons={[
                        ...
                        <CombinedButton type="channel" buttonType="square" color="blue" buttons={[
                    ...
                    <div className="button-row">
                        <CenterButton type="center" buttonType="square" color="black"
                            ...
                            arrowCenterButton={{
                                onClick: this.onClick, className: 'ok-button button-black', text: 'OK', icon: 'info_outline'
                            }}
                        >
                        </CenterButton>
                    </div>
